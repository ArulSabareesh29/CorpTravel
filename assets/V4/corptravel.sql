...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 23, 2019 at 05:07 PM
...
INSERT INTO `corp_hotels` (`hotel_id`, `hotel_name`, `hotel_type`, `rating`, `location`, `single_room`, `double_room`, `deluxe_room`, `description`) VALUES
(101, 'Citrus', 'Hotel', '3*', 'https://goo.gl/maps/R84ZYvhfo8A2', '10000', '15000', '40000', 'Citrus Leisure PLC is a public quoted company which entered the leisure industry with a commitment to build and manage a chain of distinctive hotels and resorts that are benchmarked against the most coveted in the world. Citrus intends to provide the most exceptional and memorable hospitality in Sri Lanka by exceeding guest expectations and by creating a travel experience like no other.'),
(102, 'The Kingsbury', 'Hotel', '5*', 'https://goo.gl/maps/PSUZ5pKrVdF2', '18000', '20000', '40000', 'The Kingsbury is the crown jewel of the Leisure and Aviation sector of Sri Lanka’s leading conglomerate, Hayley’s PLC and was the first hotel to be reinstated as a five-star hotel in Colombo in 2017. Since its launch in 2012, it has grown from strength to strength gaining international acclaim including Regional Winner Luxury Business Hotel in South West Asia (2016) and Winner- Best Luxury Business Hotel in Sri Lanka (2017) at The World Luxury Hotel Awards.');
...
(6, 'fgdfds', 545634654, 'Michael Marsh', 'Michael Marsh', 'dfg', 'dfg', 'arul_96@outlook.com', 54564, 'Human Resources', 269, '2019-03-23', '2019-03-30', 6, 6, 0, 'dfgdfg');
...
(4, 'Vivek', 'vivek@gmail.com', '1993-03-01', '1234', '1234', 'user');
...
--
ALTER TABLE `corp_hotels`
  MODIFY `hotel_id` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=103;
