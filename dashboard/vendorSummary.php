...
<div class="w3-bar w3-top w3-black w3-large" style="z-index:1000">
    ...
    <a href="#"><img src="../img/title_corp_travel.png" width="12%"></a>
</div>
...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
    ...
    <div class="w3-container w3-responsive">
        ...
        <div class="w3-responsive">
            <table class="data-table">
                ...
                $sql = "SELECT * FROM `trans_transport` WHERE `approval_status` LIKE '%Approved%'";
    ...
    <div class="w3-container w3-half">
        <div class="w3-responsive">
            <h3 class="w3-center">Vehicle Availability</h3>
        ...
        <div class="w3-card-4" style="width:40%;">
            ...
            <div class="w3-container w3-padding">
                <form method="post" enctype="multipart/form-data">
                    <input type="file" class="w3-padding" name="image" id="image"/>
