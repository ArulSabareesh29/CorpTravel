...
<body class="w3-light-grey">
    ...
    <div class="w3-main" style="margin-left:300px;margin-top:43px;">
                    ...
                    <table id="user_table" border="1" class=" w3-table-all w3-hoverable">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <center>
                                        <a href="delete_booking.php?id=<?php echo $row['id']; ?>"><button class="w3-btn w3-red" onclick="del_msg()">Delete</button></a>
                                    </center>
                                </td>
                            </tr>
                            <?php
        ...
        <br>
        &nbsp; <h3>User Transport Booking - Approval</h3>
                                ...
                                <form class="form-horizontal" action ="<?php $_PHP_SELF ?>">
                                    <div class="row">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="<?php echo $row['passenger_name'] ?>" value="<?php echo $row['passenger_name'] ?>" disabled>
                                        </div>
                                        <div class="form-group">
                                            <label for="pwd">Approval Status:</label>
                                            <select class="form-control" name="approval_status" id="approval_status<?php echo $row['id'] ?>">
                                                <option value="Approved">Approved</option>
                                                <option value="Decline">Decline</option>
                                            </select>
                                        </div>
                                        <div class="modal-footer">
                                            <button type="button" onclick="save_update(<?php echo $row['id'] ?>)" name="update" class="btn btn-primary">Submit</button>
