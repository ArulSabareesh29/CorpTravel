    ...
    <nav class="cyan darken-1">
      <div class="container">
        <div class="nav-wrapper">
          <a href="../index.html" class="brand-logo">Corp Travel</a>
  ...
  <div class="centerflipcards">
    <div class="square-flip">
      ...
      <div class="square2">
        <div class="square-container2">
          ...
          <a href="../bookings/transport/transport.html" target="_blank" class="boxshadow kallyas-button">View
            Transport</a>
        </div>
        <div class="flip-overlay"></div>
      </div>
    ...
    <div class="square-flip">
      ...
      <div class="square2">
        <div class="square-container2">
          <div class="align-center"></div>
          <a href="../bookings/hotel/hotel.html" target="_blank" class="boxshadow kallyas-button">View Hotels</a>
        </div>
        <div class="flip-overlay"></div>
      </div>
    </div>
    <div class="square-flip">
      ...
      <div class="square2">
        <div class="square-container2">
          <div class="align-center"></div>
          <a href="../bookings/flight/flightBooking.html" target="_blank" class="boxshadow kallyas-button">View
            Flights</a>
        </div>
        <div class="flip-overlay"></div>
      </div>
