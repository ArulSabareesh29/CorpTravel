...
<body id="home" class="scrollspy">
  ...
  <!-- Section: Follow -->
  <!-- <section class="section section-follow cyan darken-1 white-text center">
      <div class="container">
        <div class="row">
          <div class="col s12">
            <h4>Follow Corp Travel</h4>
  ...
  <!-- <section id="gallery" class="section section-gallery scrollspy">
      <div class="container">
        <h4 class="center"><span class="cyan-text">Photo</span> gallery</h4>
        <div class="row">
        ...
        <div class="row">
          ...
          <div class="col s12 m3">
            <img
              src="https://source.unsplash.com/1600x900/?transport"
              alt=""
              class="materialboxed responsive-img"
            />
          </div>
          <div class="col s12 m3">
            <img
              src="https://source.unsplash.com/1600x900/?office,travel"
              alt=""
              class="materialboxed responsive-img"
            />
          </div>
          <div class="col s12 m3">
            <img
              src="https://source.unsplash.com/1600x900/?crews"
              alt=""
              class="materialboxed responsive-img"
            />
          </div>
        ...
        <div class="row">
          <div class="col s12 m3">
            <img
              src="https://source.unsplash.com/1600x900/?offices"
              alt=""
              class="materialboxed responsive-img"
            />
          </div>
          ...
          <div class="col s12 m3">
            <img
              src="https://source.unsplash.com/1600x900/?corporate,travel"
              alt=""
              class="materialboxed responsive-img"
            />
          </div>
          <div class="col s12 m3">
            <img
              src="https://source.unsplash.com/1600x900/?taxi"
              alt=""
              class="materialboxed responsive-img"
            />
          </div>
